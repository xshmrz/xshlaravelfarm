<?php
    ...
    class Location extends Controller {
        ...
        public function store(Request $request) {
            ...
            return $request->has("redirect") ? redirect()->to($request->get("redirect")) : redirect()->route("panel.location.edit", $location->id);
        }
        ...
        public function update(Request $request, $id) {
            ...
            if (!$location) {
                ...
                return redirect()->route("panel.location.index");
            }
            $location->fill($data);
            $location->save();
            session()->flash('success', trans("app.İşlem Başarılı"));
            return $request->has("redirect") ? redirect()->to($request->get("redirect")) : redirect()->route("panel.location.edit", $id);
        }
        public function destroy($id) {
            ...
            return request()->has("redirect") ? redirect()->to(request()->get("redirect"))->withInput() : redirect()->route("panel.location.index")->withInput();
        }
    }

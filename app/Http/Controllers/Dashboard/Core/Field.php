<?php
    ...
    class Field extends Controller {
        ...
        public function store(Request $request) {
            ...
            return $request->has("redirect") ? redirect()->to($request->get("redirect")) : redirect()->route("dashboard.field.edit", $field->id);
        }
        ...
        public function update(Request $request, $id) {
            ...
            if (!$field) {
                ...
                return redirect()->route("dashboard.field.index");
            }
            $field->fill($data);
            $field->save();
            session()->flash('success', trans("app.İşlem Başarılı"));
            return $request->has("redirect") ? redirect()->to($request->get("redirect")) : redirect()->route("dashboard.field.edit", $id);
        }
        public function destroy($id) {
            ...
            return request()->has("redirect") ? redirect()->to(request()->get("redirect"))->withInput() : redirect()->route("dashboard.field.index")->withInput();
        }
    }

<?php
    ...
    class User extends Controller {
        ...
        public function store(Request $request) {
            ...
            return $request->has("redirect") ? redirect()->to($request->get("redirect")) : redirect()->route("site.user.edit", $user->id);
        }
        ...
        public function update(Request $request, $id) {
            ...
            if (!$user) {
                ...
                return redirect()->route("site.user.index");
            }
            $user->fill($data);
            $user->save();
            session()->flash('success', trans("app.İşlem Başarılı"));
            return $request->has("redirect") ? redirect()->to($request->get("redirect")) : redirect()->route("site.user.edit", $id);
        }
        public function destroy($id) {
            ...
            return request()->has("redirect") ? redirect()->to(request()->get("redirect"))->withInput() : redirect()->route("site.user.index")->withInput();
        }
    }
